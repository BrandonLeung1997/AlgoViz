...
export function SelectionSortStudio() {
  const playback = usePlayback(generateSelectionSortSteps);
      ...
      <section className="space-y-4">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight text-slate-900">
            {selectionSortMeta.title}
          </h1>
          <p className="mt-1 text-slate-600">{selectionSortMeta.summary}</p>
        </div>
