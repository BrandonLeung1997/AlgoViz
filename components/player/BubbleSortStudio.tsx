...
export function BubbleSortStudio() {
  const playback = usePlayback(generateBubbleSortSteps);
      ...
      <section className="space-y-4">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight text-slate-900">
            {bubbleSortMeta.title}
          </h1>
          <p className="mt-1 text-slate-600">{bubbleSortMeta.summary}</p>
        </div>
