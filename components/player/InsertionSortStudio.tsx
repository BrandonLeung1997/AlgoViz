...
export function InsertionSortStudio() {
  const playback = usePlayback(generateInsertionSortSteps);
      ...
      <section className="space-y-4">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight text-slate-900">
            {insertionSortMeta.title}
          </h1>
          <p className="mt-1 text-slate-600">{insertionSortMeta.summary}</p>
        </div>
