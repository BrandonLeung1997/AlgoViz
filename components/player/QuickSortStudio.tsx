...
export function QuickSortStudio() {
  const playback = usePlayback(generateQuickSortSteps);
    ...
    <div className="mx-auto grid max-w-6xl gap-6 px-4 py-6 lg:grid-cols-[1.4fr_1fr]">
      <section className="space-y-4">
        <div>
          ...
          <p className="mt-1 text-slate-600">{quickSortMeta.summary}</p>
        </div>
